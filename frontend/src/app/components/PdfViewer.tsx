...
// export function PdfViewer({ fileHex, onClose }: PdfViewerProps) {
//   const [numPages, setNumPages] = useState<number | null>(null);
//   const fileData = { data: hexToArrayBuffer(fileHex) };
...
//       <div className="bg-gray-800 rounded-lg shadow-2xl w-11/12 h-5/6 flex flex-col">
...
//               <Page key={`page_${index + 1}`} pageNumber={index + 1} renderTextLayer={true} />
//             ))}
//           </Document>
//         </div>
//       </div>
